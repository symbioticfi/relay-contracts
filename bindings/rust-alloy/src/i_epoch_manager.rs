...
```*/
    ...
    ///Container for all the [`IEpochManager`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IEpochManagerCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEpochManagerCalls {
        const NAME: &'static str = "IEpochManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IEpochManagerCalls>] = &[
                {
                    fn getNextEpochDuration(
                        ...
                        <getNextEpochDurationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getNextEpochDuration)
                    }
                ...
                },
                {
                    fn getEpochStart(
                        ...
                        <getEpochStartCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getEpochStart)
                    }
                    getEpochStart
                },
                {
                    fn setEpochDuration(
                        ...
                        <setEpochDurationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::setEpochDuration)
                    }
                    setEpochDuration
                },
                {
                    fn getCurrentEpochDuration(
                        ...
                        <getCurrentEpochDurationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getCurrentEpochDuration)
                    }
                ...
                },
                {
                    fn getNextEpochStart(
                        ...
                        <getNextEpochStartCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getNextEpochStart)
                    }
                    getNextEpochStart
                },
                {
                    fn getCurrentEpochStart(
                        ...
                        <getCurrentEpochStartCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getCurrentEpochStart)
                    }
                ...
                },
                {
                    fn getCurrentEpoch(
                        ...
                        <getCurrentEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getCurrentEpoch)
                    }
                    getCurrentEpoch
                },
                {
                    fn getEpochIndex(
                        ...
                        <getEpochIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getEpochIndex)
                    }
                    getEpochIndex
                },
                {
                    fn getNextEpoch(
                        ...
                        <getNextEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getNextEpoch)
                    }
                    getNextEpoch
                },
                {
                    fn getEpochDuration(
                        ...
                        <getEpochDurationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochManagerCalls::getEpochDuration)
                    }
                    getEpochDuration
                },
            ];
    ...
    ///Container for all the [`IEpochManager`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum IEpochManagerErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEpochManagerErrors {
        const NAME: &'static str = "IEpochManagerErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IEpochManagerErrors>] = &[
                {
                    fn EpochManager_InvalidEpochDuration(
                        ...
                        <EpochManager_InvalidEpochDuration as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IEpochManagerErrors::EpochManager_InvalidEpochDuration)
                    }
                ...
                },
                {
                    fn EpochManager_InvalidEpochDurationTimestamp(
                        ...
                        <EpochManager_InvalidEpochDurationTimestamp as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IEpochManagerErrors::EpochManager_InvalidEpochDurationTimestamp,
                            )
                    }
                    EpochManager_InvalidEpochDurationTimestamp
                },
                {
                    fn EpochManager_TooOldTimestamp(
                        ...
                        <EpochManager_TooOldTimestamp as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IEpochManagerErrors::EpochManager_TooOldTimestamp)
                    }
    ...
    ///Container for all the [`IEpochManager`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum IEpochManagerEvents {
        #[allow(missing_docs)]
        InitEpochDuration(InitEpochDuration),
        #[allow(missing_docs)]
        SetEpochDuration(SetEpochDuration),
    }
    impl IEpochManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IEpochManagerEvents {
        const NAME: &'static str = "IEpochManagerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IEpochManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
