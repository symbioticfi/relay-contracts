...
```*/
    ...
    ///Container for all the [`OzAccessControl`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum OzAccessControlCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OzAccessControlCalls {
        const NAME: &'static str = "OzAccessControlCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<OzAccessControlCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzAccessControlCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn getRoleAdmin(
                        ...
                        <getRoleAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzAccessControlCalls::getRoleAdmin)
                    }
                    getRoleAdmin
                },
                {
                    fn grantRole(
                        ...
                        <grantRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OzAccessControlCalls::grantRole)
                    }
                    grantRole
                },
                {
                    fn renounceRole(
                        ...
                        <renounceRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzAccessControlCalls::renounceRole)
                    }
                    renounceRole
                },
                {
                    fn hasRole(
                        ...
                        <hasRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OzAccessControlCalls::hasRole)
                    }
                    hasRole
                },
                {
                    fn DEFAULT_ADMIN_ROLE(
                        ...
                        <DEFAULT_ADMIN_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzAccessControlCalls::DEFAULT_ADMIN_ROLE)
                    }
                    DEFAULT_ADMIN_ROLE
                },
                {
                    fn getRole(
                        ...
                        <getRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OzAccessControlCalls::getRole)
                    }
                    getRole
                },
                {
                    fn revokeRole(
                        ...
                        <revokeRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzAccessControlCalls::revokeRole)
                    }
                    revokeRole
                },
            ];
    ...
    ///Container for all the [`OzAccessControl`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum OzAccessControlErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OzAccessControlErrors {
        const NAME: &'static str = "OzAccessControlErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<OzAccessControlErrors>] = &[
                {
                    fn AccessControlBadConfirmation(
                        ...
                        <AccessControlBadConfirmation as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzAccessControlErrors::AccessControlBadConfirmation)
                    }
                ...
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzAccessControlErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn AccessControlUnauthorizedAccount(
                        ...
                        <AccessControlUnauthorizedAccount as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzAccessControlErrors::AccessControlUnauthorizedAccount)
                    }
                ...
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzAccessControlErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`OzAccessControl`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum OzAccessControlEvents {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for OzAccessControlEvents {
        const NAME: &'static str = "OzAccessControlEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for OzAccessControlEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`OzAccessControl`](self) contract instance.

See the [wrapper's documentation](`OzAccessControlInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> OzAccessControlInstance<P, N> {
        OzAccessControlInstance::<P, N>::new(address, __provider)
    }
    /**A [`OzAccessControl`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`OzAccessControl`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct OzAccessControlInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for OzAccessControlInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("OzAccessControlInstance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`OzAccessControlInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> OzAccessControlInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> OzAccessControlInstance<P, N> {
            OzAccessControlInstance {
