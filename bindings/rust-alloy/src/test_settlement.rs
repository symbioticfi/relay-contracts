...
interface TestSettlement {
    ...
    function initialize(ISettlement.SettlementInitParams memory settlementInitParams, address _owner) external;
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            impl ::core::convert::From<initializeCall> for UnderlyingRustTuple<'_> {
                fn from(value: initializeCall) -> Self {
                    (value.settlementInitParams, value._owner)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
...
```*/
    ...
    ///Container for all the [`TestSettlement`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum TestSettlementCalls {
        #[allow(missing_docs)]
        NETWORK(NETWORKCall),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestSettlementCalls {
        const NAME: &'static str = "TestSettlementCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestSettlementCalls>] = &[
                {
                    fn getValidatorsSszMRootFromValSetHeader(
                        ...
                        <getValidatorsSszMRootFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getValidatorsSszMRootFromValSetHeader,
                            )
                    }
                ...
                },
                {
                    fn getQuorumThresholdFromValSetHeaderAt(
                        ...
                        <getQuorumThresholdFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getQuorumThresholdFromValSetHeaderAt,
                            )
                    }
                ...
                },
                {
                    fn verifyQuorumSig(
                        ...
                        <verifyQuorumSigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::verifyQuorumSig)
                    }
                    verifyQuorumSig
                },
                {
                    fn getValidatorsSszMRootFromValSetHeaderAt(
                        ...
                        <getValidatorsSszMRootFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getValidatorsSszMRootFromValSetHeaderAt,
                            )
                    }
                    getValidatorsSszMRootFromValSetHeaderAt
                },
                {
                    fn VALIDATOR_SET_VERSION(
                        ...
                        <VALIDATOR_SET_VERSIONCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::VALIDATOR_SET_VERSION)
                    }
                ...
                },
                {
                    fn getValSetHeaderHash(
                        ...
                        <getValSetHeaderHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getValSetHeaderHash)
                    }
                    getValSetHeaderHash
                },
                {
                    fn hashTypedDataV4(
                        ...
                        <hashTypedDataV4Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::hashTypedDataV4)
                    }
                    hashTypedDataV4
                },
                {
                    fn getValSetHeaderAt(
                        ...
                        <getValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getValSetHeaderAt)
                    }
                    getValSetHeaderAt
                },
                {
                    fn hashTypedDataV4CrossChain(
                        ...
                        <hashTypedDataV4CrossChainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::hashTypedDataV4CrossChain)
                    }
                ...
                },
                {
                    fn getExtraDataAt(
                        ...
                        <getExtraDataAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getExtraDataAt)
                    }
                    getExtraDataAt
                },
                {
                    fn getVersionFromValSetHeaderAt(
                        ...
                        <getVersionFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getVersionFromValSetHeaderAt)
                    }
                ...
                },
                {
                    fn getCaptureTimestampFromValSetHeaderAt(
                        ...
                        <getCaptureTimestampFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getCaptureTimestampFromValSetHeaderAt,
                            )
                    }
                ...
                },
                {
                    fn getSigVerifier(
                        ...
                        <getSigVerifierCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getSigVerifier)
                    }
                    getSigVerifier
                },
                {
                    fn isValSetHeaderCommittedAt(
                        ...
                        <isValSetHeaderCommittedAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::isValSetHeaderCommittedAt)
                    }
                ...
                },
                {
                    fn getLastCommittedHeaderEpoch(
                        ...
                        <getLastCommittedHeaderEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getLastCommittedHeaderEpoch)
                    }
                ...
                },
                {
                    fn commitValSetHeader(
                        ...
                        <commitValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::commitValSetHeader)
                    }
                    commitValSetHeader
                },
                {
                    fn SUBNETWORK(
                        ...
                        <SUBNETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::SUBNETWORK)
                    }
                    SUBNETWORK
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::eip712Domain)
                    }
                    eip712Domain
                },
                {
                    fn NETWORK(
                        ...
                        <NETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TestSettlementCalls::NETWORK)
                    }
                    NETWORK
                },
                {
                ...
                },
                {
                    fn staticDelegateCall(
                        ...
                        <staticDelegateCallCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::staticDelegateCall)
                    }
                    staticDelegateCall
                },
                {
                    fn getSigVerifierAt(
                        ...
                        <getSigVerifierAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getSigVerifierAt)
                    }
                    getSigVerifierAt
                },
                {
                    fn SUBNETWORK_IDENTIFIER(
                        ...
                        <SUBNETWORK_IDENTIFIERCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::SUBNETWORK_IDENTIFIER)
                    }
                ...
                },
                {
                    fn verifyQuorumSigAt(
                        ...
                        <verifyQuorumSigAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::verifyQuorumSigAt)
                    }
                    verifyQuorumSigAt
                },
                {
                    fn getValSetHeader(
                        ...
                        <getValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getValSetHeader)
                    }
                    getValSetHeader
                },
                {
                    fn getRequiredKeyTagFromValSetHeader(
                        ...
                        <getRequiredKeyTagFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getRequiredKeyTagFromValSetHeader)
                    }
                ...
                },
                {
                    fn setSigVerifier(
                        ...
                        <setSigVerifierCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::setSigVerifier)
                    }
                    setSigVerifier
                },
                {
                    fn getTotalVotingPowerFromValSetHeader(
                        ...
                        <getTotalVotingPowerFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getTotalVotingPowerFromValSetHeader,
                            )
                    }
                ...
                },
                {
                    fn getVersionFromValSetHeader(
                        ...
                        <getVersionFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getVersionFromValSetHeader)
                    }
                ...
                },
                {
                    fn getRequiredKeyTagFromValSetHeaderAt(
                        ...
                        <getRequiredKeyTagFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getRequiredKeyTagFromValSetHeaderAt,
                            )
                    }
                ...
                },
                {
                    fn getQuorumThresholdFromValSetHeader(
                        ...
                        <getQuorumThresholdFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getQuorumThresholdFromValSetHeader)
                    }
                ...
                },
                {
                    fn setGenesis(
                        ...
                        <setGenesisCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::setGenesis)
                    }
                    setGenesis
                },
                {
                    fn getExtraData(
                        ...
                        <getExtraDataCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getExtraData)
                    }
                    getExtraData
                },
                {
                    fn getValSetHeaderHashAt(
                        ...
                        <getValSetHeaderHashAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::getValSetHeaderHashAt)
                    }
                ...
                },
                {
                    fn getCaptureTimestampFromValSetHeader(
                        ...
                        <getCaptureTimestampFromValSetHeaderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getCaptureTimestampFromValSetHeader,
                            )
                    }
                ...
                },
                {
                    fn getTotalVotingPowerFromValSetHeaderAt(
                        ...
                        <getTotalVotingPowerFromValSetHeaderAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementCalls::getTotalVotingPowerFromValSetHeaderAt,
                            )
                    }
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestSettlementCalls::initialize)
                    }
                    initialize
                },
            ];
    ...
    ///Container for all the [`TestSettlement`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestSettlementErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestSettlementErrors {
        const NAME: &'static str = "TestSettlementErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestSettlementErrors>] = &[
                {
                    fn Settlement_VerificationFailed(
                        ...
                        <Settlement_VerificationFailed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::Settlement_VerificationFailed)
                    }
                ...
                },
                {
                    fn Settlement_ValSetHeaderAlreadyCommitted(
                        ...
                        <Settlement_ValSetHeaderAlreadyCommitted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementErrors::Settlement_ValSetHeaderAlreadyCommitted,
                            )
                    }
                ...
                },
                {
                    fn CheckpointUnorderedInsertion(
                        ...
                        <CheckpointUnorderedInsertion as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::CheckpointUnorderedInsertion)
                    }
                ...
                },
                {
                    fn NetworkManager_InvalidNetwork(
                        ...
                        <NetworkManager_InvalidNetwork as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::NetworkManager_InvalidNetwork)
                    }
                ...
                },
                {
                    fn Settlement_InvalidSigVerifier(
                        ...
                        <Settlement_InvalidSigVerifier as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::Settlement_InvalidSigVerifier)
                    }
                ...
                },
                {
                    fn Settlement_InvalidCaptureTimestamp(
                        ...
                        <Settlement_InvalidCaptureTimestamp as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementErrors::Settlement_InvalidCaptureTimestamp,
                            )
                    }
                ...
                },
                {
                    fn Settlement_InvalidValidatorsSszMRoot(
                        ...
                        <Settlement_InvalidValidatorsSszMRoot as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementErrors::Settlement_InvalidValidatorsSszMRoot,
                            )
                    }
                ...
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn Settlement_DuplicateExtraDataKey(
                        ...
                        <Settlement_DuplicateExtraDataKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::Settlement_DuplicateExtraDataKey)
                    }
                ...
                },
                {
                    fn InvalidKeyTag(
                        ...
                        <InvalidKeyTag as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::InvalidKeyTag)
                    }
                    InvalidKeyTag
                },
                {
                    fn Settlement_QuorumThresholdGtTotalVotingPower(
                        ...
                        <Settlement_QuorumThresholdGtTotalVotingPower as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestSettlementErrors::Settlement_QuorumThresholdGtTotalVotingPower,
                            )
                    }
                    Settlement_QuorumThresholdGtTotalVotingPower
                },
                {
                    fn Settlement_InvalidVersion(
                        ...
                        <Settlement_InvalidVersion as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::Settlement_InvalidVersion)
                    }
                ...
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::InvalidInitialization)
                    }
                ...
                },
                {
                    fn Settlement_InvalidEpoch(
                        ...
                        <Settlement_InvalidEpoch as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestSettlementErrors::Settlement_InvalidEpoch)
                    }
    ...
    ///Container for all the [`TestSettlement`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestSettlementEvents {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for TestSettlementEvents {
        const NAME: &'static str = "TestSettlementEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for TestSettlementEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::CommitValSetHeader(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`TestSettlement`](self) contract instance.

See the [wrapper's documentation](`TestSettlementInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> TestSettlementInstance<P, N> {
        TestSettlementInstance::<P, N>::new(address, __provider)
    }
    /**A [`TestSettlement`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`TestSettlement`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct TestSettlementInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for TestSettlementInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("TestSettlementInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
See the [wrapper's documentation](`TestSettlementInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> TestSettlementInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> TestSettlementInstance<P, N> {
            TestSettlementInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
