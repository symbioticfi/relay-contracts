...
```*/
    ...
    ///Container for all the [`NetworkManager`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum NetworkManagerCalls {
        #[allow(missing_docs)]
        NETWORK(NETWORKCall),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for NetworkManagerCalls {
        const NAME: &'static str = "NetworkManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<NetworkManagerCalls>] = &[
                {
                    fn SUBNETWORK(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<NetworkManagerCalls> {
                        <SUBNETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(NetworkManagerCalls::SUBNETWORK)
                    }
                    SUBNETWORK
                },
                {
                    fn NETWORK(
                        ...
                        <NETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(NetworkManagerCalls::NETWORK)
                    }
                    NETWORK
                },
                {
                    fn staticDelegateCall(
                        ...
                        <staticDelegateCallCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(NetworkManagerCalls::staticDelegateCall)
                    }
                    staticDelegateCall
                },
                {
                    fn SUBNETWORK_IDENTIFIER(
                        ...
                        <SUBNETWORK_IDENTIFIERCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(NetworkManagerCalls::SUBNETWORK_IDENTIFIER)
                    }
    ...
    ///Container for all the [`NetworkManager`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum NetworkManagerErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for NetworkManagerErrors {
        const NAME: &'static str = "NetworkManagerErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<NetworkManagerErrors>] = &[
                {
                    fn NetworkManager_InvalidNetwork(
                        ...
                        <NetworkManager_InvalidNetwork as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(NetworkManagerErrors::NetworkManager_InvalidNetwork)
                    }
                ...
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(NetworkManagerErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(NetworkManagerErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`NetworkManager`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum NetworkManagerEvents {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for NetworkManagerEvents {
        const NAME: &'static str = "NetworkManagerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for NetworkManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`NetworkManager`](self) contract instance.

See the [wrapper's documentation](`NetworkManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> NetworkManagerInstance<P, N> {
        NetworkManagerInstance::<P, N>::new(address, __provider)
    }
    /**A [`NetworkManager`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`NetworkManager`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct NetworkManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for NetworkManagerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("NetworkManagerInstance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`NetworkManagerInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> NetworkManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> NetworkManagerInstance<P, N> {
