...
```solidity
library IOperatorsWhitelist {
    struct OperatorsWhitelistInitParams { bool isWhitelistEnabled; }
}
```*/
#[allow(
    non_camel_case_types,
...
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct OperatorsWhitelistInitParams {
        #[allow(missing_docs)]
        pub isWhitelistEnabled: bool,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<OperatorsWhitelistInitParams>
        for UnderlyingRustTuple<'_> {
            fn from(value: OperatorsWhitelistInitParams) -> Self {
                (value.isWhitelistEnabled,)
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>>
        for OperatorsWhitelistInitParams {
            fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                Self {
                    isWhitelistEnabled: tuple.0,
                }
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolValue for OperatorsWhitelistInitParams {
            type SolType = Self;
        }
        #[automatically_derived]
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolType for OperatorsWhitelistInitParams {
            type RustType = Self;
            type Token<'a> = <UnderlyingSolTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolStruct for OperatorsWhitelistInitParams {
            const NAME: &'static str = "OperatorsWhitelistInitParams";
            #[inline]
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "OperatorsWhitelistInitParams(bool isWhitelistEnabled)",
                )
            }
            #[inline]
            fn eip712_components() -> alloy_sol_types::private::Vec<
        ...
        #[automatically_derived]
        impl alloy_sol_types::EventTopic for OperatorsWhitelistInitParams {
            #[inline]
            fn topic_preimage_length(rust: &Self::RustType) -> usize {
                0usize
                    + <alloy::sol_types::sol_data::Bool as alloy_sol_types::EventTopic>::topic_preimage_length(
                        &rust.isWhitelistEnabled,
                    )
            }
            #[inline]
            fn encode_topic_preimage(
...
interface TestOperatorsWhitelist {
    ...
    function initialize(IVotingPowerProvider.VotingPowerProviderInitParams memory votingPowerProviderInit, IOperatorsWhitelist.OperatorsWhitelistInitParams memory wlInit) external;
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "wlInit",
        "type": "tuple",
        "internalType": "struct IOperatorsWhitelist.OperatorsWhitelistInitParams",
        "components": [
          {
...
pub mod TestOperatorsWhitelist {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `initialize(((address,uint96),(string,string),bool,uint48,address),(bool))` and selector `0x1b651724`.
```solidity
function initialize(IVotingPowerProvider.VotingPowerProviderInitParams memory votingPowerProviderInit, IOperatorsWhitelist.OperatorsWhitelistInitParams memory wlInit) external;
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    ...
    pub struct initializeCall {
        ...
        #[allow(missing_docs)]
        pub wlInit: <IOperatorsWhitelist::OperatorsWhitelistInitParams as alloy::sol_types::SolType>::RustType,
    }
    ///Container type for the return parameters of the [`initialize(((address,uint96),(string,string),bool,uint48,address),(bool))`](initializeCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            type UnderlyingSolTuple<'a> = (
                ...
                IOperatorsWhitelist::OperatorsWhitelistInitParams,
            );
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <IVotingPowerProvider::VotingPowerProviderInitParams as alloy::sol_types::SolType>::RustType,
                <IOperatorsWhitelist::OperatorsWhitelistInitParams as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
            ...
            impl ::core::convert::From<initializeCall> for UnderlyingRustTuple<'_> {
                fn from(value: initializeCall) -> Self {
                    (value.votingPowerProviderInit, value.wlInit)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
        ...
        impl alloy_sol_types::SolCall for initializeCall {
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "initialize(((address,uint96),(string,string),bool,uint48,address),(bool))";
            const SELECTOR: [u8; 4] = [27u8, 101u8, 23u8, 36u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <IOperatorsWhitelist::OperatorsWhitelistInitParams as alloy_sol_types::SolType>::tokenize(
                        &self.wlInit,
                    ),
                )
            }
...
```*/
    ...
    ///Container for all the [`TestOperatorsWhitelist`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum TestOperatorsWhitelistCalls {
        #[allow(missing_docs)]
        NETWORK(NETWORKCall),
        #[allow(missing_docs)]
    ...
    impl TestOperatorsWhitelistCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestOperatorsWhitelistCalls {
        const NAME: &'static str = "TestOperatorsWhitelistCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestOperatorsWhitelistCalls>] = &[
                {
                    fn stakeToVotingPower(
                        ...
                        <stakeToVotingPowerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::stakeToVotingPower)
                    }
                    stakeToVotingPower
                },
                {
                    fn registerToken(
                        ...
                        <registerTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::registerToken)
                    }
                    registerToken
                },
                {
                    fn isOperatorVaultRegistered_0(
                        ...
                        <isOperatorVaultRegistered_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::isOperatorVaultRegistered_0,
                            )
                    }
                ...
                },
                {
                    fn VAULT_FACTORY(
                        ...
                        <VAULT_FACTORYCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::VAULT_FACTORY)
                    }
                    VAULT_FACTORY
                },
                {
                    fn getOperatorVaults(
                        ...
                        <getOperatorVaultsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorVaults)
                    }
                    getOperatorVaults
                },
                {
                    fn getTokensAt(
                        ...
                        <getTokensAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getTokensAt)
                    }
                    getTokensAt
                },
                {
                    fn isWhitelistEnabled(
                        ...
                        <isWhitelistEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isWhitelistEnabled)
                    }
                    isWhitelistEnabled
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::initialize)
                    }
                    initialize
                },
                {
                    fn isTokenRegistered(
                        ...
                        <isTokenRegisteredCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isTokenRegistered)
                    }
                    isTokenRegistered
                },
                {
                    fn getOperators(
                        ...
                        <getOperatorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperators)
                    }
                    getOperators
                },
                {
                    fn whitelistOperator(
                        ...
                        <whitelistOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::whitelistOperator)
                    }
                    whitelistOperator
                },
                {
                    fn registerOperator(
                        ...
                        <registerOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::registerOperator)
                    }
                    registerOperator
                },
                {
                    fn isOperatorWhitelisted(
                        ...
                        <isOperatorWhitelistedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isOperatorWhitelisted)
                    }
                ...
                },
                {
                    fn getOperatorVotingPowersAt(
                        ...
                        <getOperatorVotingPowersAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorVotingPowersAt)
                    }
                ...
                },
                {
                    fn hashTypedDataV4(
                        ...
                        <hashTypedDataV4Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::hashTypedDataV4)
                    }
                    hashTypedDataV4
                },
                {
                    fn getOperatorVaultsAt(
                        ...
                        <getOperatorVaultsAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorVaultsAt)
                    }
                    getOperatorVaultsAt
                },
                {
                    fn getSharedVaultsAt(
                        ...
                        <getSharedVaultsAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getSharedVaultsAt)
                    }
                    getSharedVaultsAt
                },
                {
                    fn setWhitelistStatus(
                        ...
                        <setWhitelistStatusCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::setWhitelistStatus)
                    }
                    setWhitelistStatus
                },
                {
                    fn hashTypedDataV4CrossChain(
                        ...
                        <hashTypedDataV4CrossChainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::hashTypedDataV4CrossChain)
                    }
                ...
                },
                {
                    fn stakeToVotingPowerAt(
                        ...
                        <stakeToVotingPowerAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::stakeToVotingPowerAt)
                    }
                ...
                },
                {
                    fn invalidateOldSignatures(
                        ...
                        <invalidateOldSignaturesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::invalidateOldSignatures)
                    }
                ...
                },
                {
                    fn getOperatorVotingPowers(
                        ...
                        <getOperatorVotingPowersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorVotingPowers)
                    }
                ...
                },
                {
                    fn isOperatorVaultRegistered_1(
                        ...
                        <isOperatorVaultRegistered_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::isOperatorVaultRegistered_1,
                            )
                    }
                ...
                },
                {
                    fn isTokenRegisteredAt(
                        ...
                        <isTokenRegisteredAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isTokenRegisteredAt)
                    }
                    isTokenRegisteredAt
                },
                {
                    fn isOperatorRegistered(
                        ...
                        <isOperatorRegisteredCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isOperatorRegistered)
                    }
                ...
                },
                {
                    fn unwhitelistOperator(
                        ...
                        <unwhitelistOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::unwhitelistOperator)
                    }
                    unwhitelistOperator
                },
                {
                    fn unregisterOperatorVault_0(
                        ...
                        <unregisterOperatorVault_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::unregisterOperatorVault_0)
                    }
                ...
                },
                {
                    fn SUBNETWORK(
                        ...
                        <SUBNETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::SUBNETWORK)
                    }
                    SUBNETWORK
                },
                {
                    fn unregisterToken(
                        ...
                        <unregisterTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::unregisterToken)
                    }
                    unregisterToken
                },
                {
                    fn getVotingPowersAt(
                        ...
                        <getVotingPowersAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getVotingPowersAt)
                    }
                    getVotingPowersAt
                },
                {
                    fn getSlashingDataAt(
                        ...
                        <getSlashingDataAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getSlashingDataAt)
                    }
                    getSlashingDataAt
                },
                {
                    fn nonces(
                        ...
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TestOperatorsWhitelistCalls::nonces)
                    }
                    nonces
                },
                {
                    fn OPERATOR_REGISTRY(
                        ...
                        <OPERATOR_REGISTRYCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::OPERATOR_REGISTRY)
                    }
                    OPERATOR_REGISTRY
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::eip712Domain)
                    }
                    eip712Domain
                },
                {
                    fn NETWORK(
                        ...
                        <NETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TestOperatorsWhitelistCalls::NETWORK)
                    }
                    NETWORK
                },
                {
                    fn isOperatorRegisteredAt(
                        ...
                        <isOperatorRegisteredAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isOperatorRegisteredAt)
                    }
                ...
                },
                {
                    fn getOperatorStakes(
                        ...
                        <getOperatorStakesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorStakes)
                    }
                    getOperatorStakes
                },
                {
                    fn isSharedVaultRegistered(
                        ...
                        <isSharedVaultRegisteredCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isSharedVaultRegistered)
                    }
                ...
                },
                {
                    fn staticDelegateCall(
                        ...
                        <staticDelegateCallCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::staticDelegateCall)
                    }
                    staticDelegateCall
                },
                {
                    fn getOperatorsAt(
                        ...
                        <getOperatorsAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorsAt)
                    }
                    getOperatorsAt
                },
                {
                    fn getOperatorStakesAt(
                        ...
                        <getOperatorStakesAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getOperatorStakesAt)
                    }
                    getOperatorStakesAt
                },
                {
                    fn unregisterOperator(
                        ...
                        <unregisterOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::unregisterOperator)
                    }
                    unregisterOperator
                },
                {
                    fn getTokens(
                        ...
                        <getTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TestOperatorsWhitelistCalls::getTokens)
                    }
                    getTokens
                },
                {
                    fn SUBNETWORK_IDENTIFIER(
                        ...
                        <SUBNETWORK_IDENTIFIERCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::SUBNETWORK_IDENTIFIER)
                    }
                ...
                },
                {
                    fn multicall(
                        ...
                        <multicallCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(TestOperatorsWhitelistCalls::multicall)
                    }
                    multicall
                },
                {
                    fn registerOperatorVault(
                        ...
                        <registerOperatorVaultCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::registerOperatorVault)
                    }
                ...
                },
                {
                    fn getSharedVaults(
                        ...
                        <getSharedVaultsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getSharedVaults)
                    }
                    getSharedVaults
                },
                {
                    fn unregisterOperatorVault_1(
                        ...
                        <unregisterOperatorVault_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::unregisterOperatorVault_1)
                    }
                ...
                },
                {
                    fn isOperatorVaultRegisteredAt_0(
                        ...
                        <isOperatorVaultRegisteredAt_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::isOperatorVaultRegisteredAt_0,
                            )
                    }
                ...
                },
                {
                    fn isSharedVaultRegisteredAt(
                        ...
                        <isSharedVaultRegisteredAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::isSharedVaultRegisteredAt)
                    }
                ...
                },
                {
                    fn registerOperatorWithSignature(
                        ...
                        <registerOperatorWithSignatureCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::registerOperatorWithSignature,
                            )
                    }
                ...
                },
                {
                    fn isOperatorVaultRegisteredAt_1(
                        ...
                        <isOperatorVaultRegisteredAt_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::isOperatorVaultRegisteredAt_1,
                            )
                    }
                ...
                },
                {
                    fn getSlashingData(
                        ...
                        <getSlashingDataCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getSlashingData)
                    }
                    getSlashingData
                },
                {
                    fn unregisterOperatorWithSignature(
                        ...
                        <unregisterOperatorWithSignatureCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistCalls::unregisterOperatorWithSignature,
                            )
                    }
                ...
                },
                {
                    fn getVotingPowers(
                        ...
                        <getVotingPowersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistCalls::getVotingPowers)
                    }
                    getVotingPowers
                },
            ];
    ...
    ///Container for all the [`TestOperatorsWhitelist`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestOperatorsWhitelistErrors {
        #[allow(missing_docs)]
    ...
    impl TestOperatorsWhitelistErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestOperatorsWhitelistErrors {
        const NAME: &'static str = "TestOperatorsWhitelistErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestOperatorsWhitelistErrors>] = &[
                {
                    fn VotingPowerProvider_InvalidSharedVault(
                        ...
                        <VotingPowerProvider_InvalidSharedVault as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidSharedVault,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_InvalidOperatorVault(
                        ...
                        <VotingPowerProvider_InvalidOperatorVault as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidOperatorVault,
                            )
                    }
                    VotingPowerProvider_InvalidOperatorVault
                },
                {
                    fn VotingPowerProvider_OperatorAlreadyRegistered(
                        ...
                        <VotingPowerProvider_OperatorAlreadyRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_OperatorAlreadyRegistered,
                            )
                    }
                    VotingPowerProvider_OperatorAlreadyRegistered
                },
                {
                    fn NetworkManager_InvalidNetwork(
                        ...
                        <NetworkManager_InvalidNetwork as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::NetworkManager_InvalidNetwork,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_OperatorVaultNotRegistered(
                        ...
                        <VotingPowerProvider_OperatorVaultNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_OperatorVaultNotRegistered,
                            )
                    }
                    VotingPowerProvider_OperatorVaultNotRegistered
                },
                {
                    fn VotingPowerProvider_InvalidOperator(
                        ...
                        <VotingPowerProvider_InvalidOperator as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidOperator,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_OperatorNotRegistered(
                        ...
                        <VotingPowerProvider_OperatorNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_OperatorNotRegistered,
                            )
                    }
                    VotingPowerProvider_OperatorNotRegistered
                },
                {
                    fn InvalidAccountNonce(
                        ...
                        <InvalidAccountNonce as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistErrors::InvalidAccountNonce)
                    }
                    InvalidAccountNonce
                },
                {
                    fn VotingPowerProvider_SharedVaultNotRegistered(
                        ...
                        <VotingPowerProvider_SharedVaultNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_SharedVaultNotRegistered,
                            )
                    }
                    VotingPowerProvider_SharedVaultNotRegistered
                },
                {
                    fn AddressEmptyCode(
                        ...
                        <AddressEmptyCode as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistErrors::AddressEmptyCode)
                    }
                    AddressEmptyCode
                },
                {
                    fn VotingPowerProvider_InvalidToken(
                        ...
                        <VotingPowerProvider_InvalidToken as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidToken,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_InvalidSignature(
                        ...
                        <VotingPowerProvider_InvalidSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidSignature,
                            )
                    }
                ...
                },
                {
                    fn OperatorsWhitelist_StatusAlreadySet(
                        ...
                        <OperatorsWhitelist_StatusAlreadySet as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::OperatorsWhitelist_StatusAlreadySet,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_InvalidVault(
                        ...
                        <VotingPowerProvider_InvalidVault as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_InvalidVault,
                            )
                    }
                ...
                },
                {
                    fn VotingPowerProvider_TokenAlreadyIsRegistered(
                        ...
                        <VotingPowerProvider_TokenAlreadyIsRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_TokenAlreadyIsRegistered,
                            )
                    }
                    VotingPowerProvider_TokenAlreadyIsRegistered
                },
                {
                    fn VotingPowerProvider_OperatorVaultAlreadyIsRegistered(
                        ...
                        <VotingPowerProvider_OperatorVaultAlreadyIsRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_OperatorVaultAlreadyIsRegistered,
                            )
                    }
                    VotingPowerProvider_OperatorVaultAlreadyIsRegistered
                },
                {
                    fn VotingPowerProvider_TokenNotRegistered(
                        ...
                        <VotingPowerProvider_TokenNotRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_TokenNotRegistered,
                            )
                    }
                ...
                },
                {
                    fn FailedCall(
                        ...
                        <FailedCall as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(TestOperatorsWhitelistErrors::FailedCall)
                    }
                    FailedCall
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn VotingPowerProvider_SharedVaultAlreadyIsRegistered(
                        ...
                        <VotingPowerProvider_SharedVaultAlreadyIsRegistered as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::VotingPowerProvider_SharedVaultAlreadyIsRegistered,
                            )
                    }
                    VotingPowerProvider_SharedVaultAlreadyIsRegistered
                },
                {
                    fn OperatorsWhitelist_OperatorNotWhitelisted(
                        ...
                        <OperatorsWhitelist_OperatorNotWhitelisted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::OperatorsWhitelist_OperatorNotWhitelisted,
                            )
                    }
                    OperatorsWhitelist_OperatorNotWhitelisted
                },
                {
                    fn OperatorsWhitelist_OperatorWhitelisted(
                        ...
                        <OperatorsWhitelist_OperatorWhitelisted as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                TestOperatorsWhitelistErrors::OperatorsWhitelist_OperatorWhitelisted,
                            )
                    }
                ...
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOperatorsWhitelistErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`TestOperatorsWhitelist`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestOperatorsWhitelistEvents {
        #[allow(missing_docs)]
    ...
    impl TestOperatorsWhitelistEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for TestOperatorsWhitelistEvents {
        const NAME: &'static str = "TestOperatorsWhitelistEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for TestOperatorsWhitelistEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`TestOperatorsWhitelist`](self) contract instance.

See the [wrapper's documentation](`TestOperatorsWhitelistInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> TestOperatorsWhitelistInstance<P, N> {
        TestOperatorsWhitelistInstance::<P, N>::new(address, __provider)
    }
    /**A [`TestOperatorsWhitelist`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`TestOperatorsWhitelist`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct TestOperatorsWhitelistInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for TestOperatorsWhitelistInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("TestOperatorsWhitelistInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
See the [wrapper's documentation](`TestOperatorsWhitelistInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> TestOperatorsWhitelistInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> TestOperatorsWhitelistInstance<P, N> {
            TestOperatorsWhitelistInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
    ...
    > TestOperatorsWhitelistInstance<P, N> {
        ...
        pub fn initialize(
            ...
            wlInit: <IOperatorsWhitelist::OperatorsWhitelistInitParams as alloy::sol_types::SolType>::RustType,
