...
```*/
    ...
    ///Container for all the [`KeyRegistry`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum KeyRegistryCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for KeyRegistryCalls {
        const NAME: &'static str = "KeyRegistryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<KeyRegistryCalls>] = &[
                {
                    fn getKeysOperators(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<KeyRegistryCalls> {
                        <getKeysOperatorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getKeysOperators)
                    }
                    getKeysOperators
                },
                {
                    fn getKeys_0(
                        ...
                        <getKeys_0Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::getKeys_0)
                    }
                    getKeys_0
                },
                {
                    fn getKeysAt_0(
                        ...
                        <getKeysAt_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getKeysAt_0)
                    }
                    getKeysAt_0
                },
                {
                    fn getKeysAt_1(
                        ...
                        <getKeysAt_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getKeysAt_1)
                    }
                    getKeysAt_1
                },
                {
                    fn getKeys_1(
                        ...
                        <getKeys_1Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::getKeys_1)
                    }
                    getKeys_1
                },
                {
                    fn hashTypedDataV4(
                        ...
                        <hashTypedDataV4Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::hashTypedDataV4)
                    }
                    hashTypedDataV4
                },
                {
                    fn hashTypedDataV4CrossChain(
                        ...
                        <hashTypedDataV4CrossChainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::hashTypedDataV4CrossChain)
                    }
                ...
                },
                {
                    fn __KeyRegistry_init(
                        ...
                        <__KeyRegistry_initCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::__KeyRegistry_init)
                    }
                    __KeyRegistry_init
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::eip712Domain)
                    }
                    eip712Domain
                },
                {
                    fn getOperator(
                        ...
                        <getOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getOperator)
                    }
                    getOperator
                },
                {
                    fn multicall(
                        ...
                        <multicallCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::multicall)
                    }
                    multicall
                },
                {
                    fn getKeyAt(
                        ...
                        <getKeyAtCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::getKeyAt)
                    }
                    getKeyAt
                },
                {
                    fn getKey(data: &[u8]) -> alloy_sol_types::Result<KeyRegistryCalls> {
                        <getKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::getKey)
                    }
                    getKey
                },
                {
                    fn setKey(data: &[u8]) -> alloy_sol_types::Result<KeyRegistryCalls> {
                        <setKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(KeyRegistryCalls::setKey)
                    }
                    setKey
                },
                {
                    fn getKeysOperatorsLength(
                        ...
                        <getKeysOperatorsLengthCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getKeysOperatorsLength)
                    }
                ...
                },
                {
                    fn getKeysOperatorsAt(
                        ...
                        <getKeysOperatorsAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(KeyRegistryCalls::getKeysOperatorsAt)
                    }
                    getKeysOperatorsAt
                },
            ];
    ...
    ///Container for all the [`KeyRegistry`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum KeyRegistryErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for KeyRegistryErrors {
        const NAME: &'static str = "KeyRegistryErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<KeyRegistryErrors>] = &[
                {
                    fn SigEcdsaSecp256k1_InvalidMessageLength(
                        ...
                        <SigEcdsaSecp256k1_InvalidMessageLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                KeyRegistryErrors::SigEcdsaSecp256k1_InvalidMessageLength,
                            )
                    }
                ...
                },
                {
                    fn KeyBlsBls12381_InvalidKey(
                        ...
                        <KeyBlsBls12381_InvalidKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyBlsBls12381_InvalidKey)
                    }
                ...
                },
                {
                    fn CheckpointUnorderedInsertion(
                        ...
                        <CheckpointUnorderedInsertion as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::CheckpointUnorderedInsertion)
                    }
                ...
                },
                {
                    fn InvalidDSTLength(
                        ...
                        <InvalidDSTLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::InvalidDSTLength)
                    }
                    InvalidDSTLength
                },
                {
                    fn KeyBlsBn254_InvalidBytes(
                        ...
                        <KeyBlsBn254_InvalidBytes as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyBlsBn254_InvalidBytes)
                    }
                ...
                },
                {
                    fn KeyBlsBls12381_InvalidBytes(
                        ...
                        <KeyBlsBls12381_InvalidBytes as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyBlsBls12381_InvalidBytes)
                    }
                ...
                },
                {
                    fn AddressEmptyCode(
                        ...
                        <AddressEmptyCode as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::AddressEmptyCode)
                    }
                    AddressEmptyCode
                },
                {
                    fn KeyRegistry_InvalidKeySignature(
                        ...
                        <KeyRegistry_InvalidKeySignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyRegistry_InvalidKeySignature)
                    }
                ...
                },
                {
                    fn FailedCall(
                        ...
                        <FailedCall as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(KeyRegistryErrors::FailedCall)
                    }
                    FailedCall
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn SigBlsBls12381_InvalidMessageLength(
                        ...
                        <SigBlsBls12381_InvalidMessageLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::SigBlsBls12381_InvalidMessageLength)
                    }
                ...
                },
                {
                    fn InvalidKeyTag(
                        ...
                        <InvalidKeyTag as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::InvalidKeyTag)
                    }
                    InvalidKeyTag
                },
                {
                    fn KeyEcdsaSecp256k1_InvalidBytes(
                        ...
                        <KeyEcdsaSecp256k1_InvalidBytes as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyEcdsaSecp256k1_InvalidBytes)
                    }
                ...
                },
                {
                    fn KeyRegistry_InvalidKeyType(
                        ...
                        <KeyRegistry_InvalidKeyType as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyRegistry_InvalidKeyType)
                    }
                ...
                },
                {
                    fn KeyRegistry_AlreadyUsed(
                        ...
                        <KeyRegistry_AlreadyUsed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyRegistry_AlreadyUsed)
                    }
                ...
                },
                {
                    fn SigBlsBn254_InvalidMessageLength(
                        ...
                        <SigBlsBn254_InvalidMessageLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::SigBlsBn254_InvalidMessageLength)
                    }
                ...
                },
                {
                    fn KeyBlsBn254_InvalidKey(
                        ...
                        <KeyBlsBn254_InvalidKey as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::KeyBlsBn254_InvalidKey)
                    }
                ...
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(KeyRegistryErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`KeyRegistry`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum KeyRegistryEvents {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for KeyRegistryEvents {
        const NAME: &'static str = "KeyRegistryEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for KeyRegistryEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`KeyRegistry`](self) contract instance.

See the [wrapper's documentation](`KeyRegistryInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> KeyRegistryInstance<P, N> {
        KeyRegistryInstance::<P, N>::new(address, __provider)
    }
    /**A [`KeyRegistry`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`KeyRegistry`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct KeyRegistryInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for KeyRegistryInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("KeyRegistryInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
See the [wrapper's documentation](`KeyRegistryInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> KeyRegistryInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> KeyRegistryInstance<P, N> {
            KeyRegistryInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
