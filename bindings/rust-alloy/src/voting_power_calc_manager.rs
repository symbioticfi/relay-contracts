...
```solidity
interface VotingPowerCalcManager {
...
pub mod VotingPowerCalcManager {
    use super::*;
...
```*/
    ...
    ///Container for all the [`VotingPowerCalcManager`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum VotingPowerCalcManagerCalls {
        #[allow(missing_docs)]
        stakeToVotingPower(stakeToVotingPowerCall),
        #[allow(missing_docs)]
        stakeToVotingPowerAt(stakeToVotingPowerAtCall),
    }
    impl VotingPowerCalcManagerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for VotingPowerCalcManagerCalls {
        const NAME: &'static str = "VotingPowerCalcManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<VotingPowerCalcManagerCalls>] = &[
                {
                    fn stakeToVotingPower(
                        ...
                        <stakeToVotingPowerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(VotingPowerCalcManagerCalls::stakeToVotingPower)
                    }
                    stakeToVotingPower
                },
                {
                    fn stakeToVotingPowerAt(
                        ...
                        <stakeToVotingPowerAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(VotingPowerCalcManagerCalls::stakeToVotingPowerAt)
                    }
    ...
    ///Container for all the [`VotingPowerCalcManager`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum VotingPowerCalcManagerErrors {
        #[allow(missing_docs)]
        InvalidInitialization(InvalidInitialization),
        #[allow(missing_docs)]
        NotInitializing(NotInitializing),
    }
    impl VotingPowerCalcManagerErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for VotingPowerCalcManagerErrors {
        const NAME: &'static str = "VotingPowerCalcManagerErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<VotingPowerCalcManagerErrors>] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<VotingPowerCalcManagerErrors> {
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(VotingPowerCalcManagerErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(VotingPowerCalcManagerErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`VotingPowerCalcManager`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum VotingPowerCalcManagerEvents {
        #[allow(missing_docs)]
        Initialized(Initialized),
    }
    impl VotingPowerCalcManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for VotingPowerCalcManagerEvents {
        const NAME: &'static str = "VotingPowerCalcManagerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for VotingPowerCalcManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`VotingPowerCalcManager`](self) contract instance.

See the [wrapper's documentation](`VotingPowerCalcManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> VotingPowerCalcManagerInstance<P, N> {
        VotingPowerCalcManagerInstance::<P, N>::new(address, __provider)
    }
    /**A [`VotingPowerCalcManager`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`VotingPowerCalcManager`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct VotingPowerCalcManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for VotingPowerCalcManagerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("VotingPowerCalcManagerInstance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`VotingPowerCalcManagerInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> VotingPowerCalcManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> VotingPowerCalcManagerInstance<P, N> {
            VotingPowerCalcManagerInstance {
