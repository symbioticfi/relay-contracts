...
```solidity
interface NormalizedTokenDecimalsVPCalc {
...
pub mod NormalizedTokenDecimalsVPCalc {
    use super::*;
...
```*/
    ...
    ///Container for all the [`NormalizedTokenDecimalsVPCalc`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum NormalizedTokenDecimalsVPCalcCalls {
        #[allow(missing_docs)]
        stakeToVotingPower(stakeToVotingPowerCall),
        #[allow(missing_docs)]
        stakeToVotingPowerAt(stakeToVotingPowerAtCall),
    }
    impl NormalizedTokenDecimalsVPCalcCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for NormalizedTokenDecimalsVPCalcCalls {
        const NAME: &'static str = "NormalizedTokenDecimalsVPCalcCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<NormalizedTokenDecimalsVPCalcCalls>] = &[
                {
                    fn stakeToVotingPower(
                        ...
                        <stakeToVotingPowerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(NormalizedTokenDecimalsVPCalcCalls::stakeToVotingPower)
                    }
                    stakeToVotingPower
                },
                {
                    fn stakeToVotingPowerAt(
                        ...
                        <stakeToVotingPowerAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                NormalizedTokenDecimalsVPCalcCalls::stakeToVotingPowerAt,
                            )
                    }
    ...
    ///Container for all the [`NormalizedTokenDecimalsVPCalc`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum NormalizedTokenDecimalsVPCalcErrors {
        #[allow(missing_docs)]
        InvalidInitialization(InvalidInitialization),
        #[allow(missing_docs)]
        NotInitializing(NotInitializing),
    }
    impl NormalizedTokenDecimalsVPCalcErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for NormalizedTokenDecimalsVPCalcErrors {
        const NAME: &'static str = "NormalizedTokenDecimalsVPCalcErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<NormalizedTokenDecimalsVPCalcErrors>] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<NormalizedTokenDecimalsVPCalcErrors> {
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(NormalizedTokenDecimalsVPCalcErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                NormalizedTokenDecimalsVPCalcErrors::InvalidInitialization,
                            )
                    }
    ...
    ///Container for all the [`NormalizedTokenDecimalsVPCalc`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum NormalizedTokenDecimalsVPCalcEvents {
        #[allow(missing_docs)]
        Initialized(Initialized),
    }
    impl NormalizedTokenDecimalsVPCalcEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for NormalizedTokenDecimalsVPCalcEvents {
        const NAME: &'static str = "NormalizedTokenDecimalsVPCalcEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for NormalizedTokenDecimalsVPCalcEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`NormalizedTokenDecimalsVPCalc`](self) contract instance.

See the [wrapper's documentation](`NormalizedTokenDecimalsVPCalcInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> NormalizedTokenDecimalsVPCalcInstance<P, N> {
        NormalizedTokenDecimalsVPCalcInstance::<P, N>::new(address, __provider)
    }
    /**A [`NormalizedTokenDecimalsVPCalc`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`NormalizedTokenDecimalsVPCalc`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct NormalizedTokenDecimalsVPCalcInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for NormalizedTokenDecimalsVPCalcInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("NormalizedTokenDecimalsVPCalcInstance")
                .field(&self.address)
                .finish()
        }
    }
...
See the [wrapper's documentation](`NormalizedTokenDecimalsVPCalcInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> NormalizedTokenDecimalsVPCalcInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(
            self,
        ) -> NormalizedTokenDecimalsVPCalcInstance<P, N> {
            NormalizedTokenDecimalsVPCalcInstance {
