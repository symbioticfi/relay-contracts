...
```*/
            ...
            ) -> alloy_sol_types::Result<IOzAccessControlCalls>] = &[
                {
                    fn getRoleAdmin(
                        ...
                        <getRoleAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOzAccessControlCalls::getRoleAdmin)
                    }
                    getRoleAdmin
                },
                {
                    fn grantRole(
                        ...
                        <grantRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IOzAccessControlCalls::grantRole)
                    }
                    grantRole
                },
                {
                    fn renounceRole(
                        ...
                        <renounceRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOzAccessControlCalls::renounceRole)
                    }
                    renounceRole
                },
                {
                    fn hasRole(
                        ...
                        <hasRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IOzAccessControlCalls::hasRole)
                    }
                    hasRole
                },
                {
                ...
                },
                {
                    fn revokeRole(
                        ...
                        <revokeRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOzAccessControlCalls::revokeRole)
                    }
                    revokeRole
                },
            ];
    ...
    ///Container for all the [`IOzAccessControl`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum IOzAccessControlErrors {
        #[allow(missing_docs)]
        AccessControlBadConfirmation(AccessControlBadConfirmation),
        #[allow(missing_docs)]
        AccessControlUnauthorizedAccount(AccessControlUnauthorizedAccount),
    }
    impl IOzAccessControlErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IOzAccessControlErrors {
        const NAME: &'static str = "IOzAccessControlErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IOzAccessControlErrors>] = &[
                {
                    fn AccessControlBadConfirmation(
                        ...
                        <AccessControlBadConfirmation as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IOzAccessControlErrors::AccessControlBadConfirmation)
                    }
                ...
                },
                {
                    fn AccessControlUnauthorizedAccount(
                        ...
                        <AccessControlUnauthorizedAccount as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                IOzAccessControlErrors::AccessControlUnauthorizedAccount,
                            )
                    }
