...
```*/
    ...
    ///Container for all the [`OzEIP712`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum OzEIP712Calls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OzEIP712Calls {
        const NAME: &'static str = "OzEIP712Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<OzEIP712Calls>] = &[
                {
                    fn hashTypedDataV4(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<OzEIP712Calls> {
                        <hashTypedDataV4Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzEIP712Calls::hashTypedDataV4)
                    }
                    hashTypedDataV4
                },
                {
                    fn hashTypedDataV4CrossChain(
                        ...
                        <hashTypedDataV4CrossChainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzEIP712Calls::hashTypedDataV4CrossChain)
                    }
                ...
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(OzEIP712Calls::eip712Domain)
                    }
                    eip712Domain
                },
            ];
    ...
    ///Container for all the [`OzEIP712`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum OzEIP712Errors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for OzEIP712Errors {
        const NAME: &'static str = "OzEIP712Errors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<OzEIP712Errors>] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<OzEIP712Errors> {
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzEIP712Errors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(OzEIP712Errors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`OzEIP712`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum OzEIP712Events {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for OzEIP712Events {
        const NAME: &'static str = "OzEIP712Events";
        const COUNT: usize = 3usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for OzEIP712Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`OzEIP712`](self) contract instance.

See the [wrapper's documentation](`OzEIP712Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> OzEIP712Instance<P, N> {
        OzEIP712Instance::<P, N>::new(address, __provider)
    }
    /**A [`OzEIP712`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`OzEIP712`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct OzEIP712Instance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for OzEIP712Instance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("OzEIP712Instance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`OzEIP712Instance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> OzEIP712Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> OzEIP712Instance<P, N> {
            OzEIP712Instance {
