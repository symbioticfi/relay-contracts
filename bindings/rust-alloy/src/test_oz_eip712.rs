...
```*/
    ...
    ///Container for all the [`TestOzEIP712`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum TestOzEIP712Calls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestOzEIP712Calls {
        const NAME: &'static str = "TestOzEIP712Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestOzEIP712Calls>] = &[
                {
                    fn hashTypedDataV4(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<TestOzEIP712Calls> {
                        <hashTypedDataV4Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Calls::hashTypedDataV4)
                    }
                    hashTypedDataV4
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Calls::initialize)
                    }
                    initialize
                },
                {
                    fn hashTypedDataV4CrossChain(
                        ...
                        <hashTypedDataV4CrossChainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Calls::hashTypedDataV4CrossChain)
                    }
                ...
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Calls::eip712Domain)
                    }
                    eip712Domain
                },
            ];
    ...
    ///Container for all the [`TestOzEIP712`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestOzEIP712Errors {
        #[allow(missing_docs)]
        InvalidInitialization(InvalidInitialization),
        #[allow(missing_docs)]
        NotInitializing(NotInitializing),
    }
    impl TestOzEIP712Errors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for TestOzEIP712Errors {
        const NAME: &'static str = "TestOzEIP712Errors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<TestOzEIP712Errors>] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<TestOzEIP712Errors> {
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Errors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(TestOzEIP712Errors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`TestOzEIP712`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum TestOzEIP712Events {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for TestOzEIP712Events {
        const NAME: &'static str = "TestOzEIP712Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for TestOzEIP712Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`TestOzEIP712`](self) contract instance.

See the [wrapper's documentation](`TestOzEIP712Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> TestOzEIP712Instance<P, N> {
        TestOzEIP712Instance::<P, N>::new(address, __provider)
    }
    /**A [`TestOzEIP712`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`TestOzEIP712`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct TestOzEIP712Instance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for TestOzEIP712Instance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("TestOzEIP712Instance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`TestOzEIP712Instance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> TestOzEIP712Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> TestOzEIP712Instance<P, N> {
            TestOzEIP712Instance {
    ...
    > TestOzEIP712Instance<P, N> {
        ...
        pub fn initialize(
            ...
            self.call_builder(&initializeCall { _name, _version })
        }
    }
    /// Event filters.
    impl<
