...
using Symbiotic.Relay.OperatorsWhitelist.abi.ContractDefinition;

namespace Symbiotic.Relay.OperatorsWhitelist.abi
{
    public partial class OperatorsWhitelist.abiService: OperatorsWhitelist.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, OperatorsWhitelist.abiDeployment operatorsWhitelist.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsWhitelist.abiDeployment>().SendRequestAndWaitForReceiptAsync(operatorsWhitelist.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, OperatorsWhitelist.abiDeployment operatorsWhitelist.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsWhitelist.abiDeployment>().SendRequestAsync(operatorsWhitelist.abiDeployment);
        }

        public static async Task<OperatorsWhitelist.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, OperatorsWhitelist.abiDeployment operatorsWhitelist.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, operatorsWhitelist.abiDeployment, cancellationTokenSource);
            return new OperatorsWhitelist.abiService(web3, receipt.ContractAddress);
        }

        public OperatorsWhitelist.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class OperatorsWhitelist.abiServiceBase: ContractWeb3ServiceBase
    {

        public OperatorsWhitelist.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
