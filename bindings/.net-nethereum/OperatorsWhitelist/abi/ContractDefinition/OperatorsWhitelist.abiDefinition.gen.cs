...
namespace Symbiotic.Relay.OperatorsWhitelist.abi.ContractDefinition
{
    ...
    public partial class OperatorsWhitelist.abiDeployment : OperatorsWhitelist.abiDeploymentBase
    {
        public OperatorsWhitelist.abiDeployment() : base(BYTECODE) { }
        public OperatorsWhitelist.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OperatorsWhitelist.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OperatorsWhitelist.abiDeploymentBase() : base(BYTECODE) { }
        public OperatorsWhitelist.abiDeploymentBase(string byteCode) : base(byteCode) { }
