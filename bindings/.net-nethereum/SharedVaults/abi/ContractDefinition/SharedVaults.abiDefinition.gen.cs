...
namespace Symbiotic.Relay.SharedVaults.abi.ContractDefinition
{


    public partial class SharedVaults.abiDeployment : SharedVaults.abiDeploymentBase
    {
        public SharedVaults.abiDeployment() : base(BYTECODE) { }
        public SharedVaults.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class SharedVaults.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public SharedVaults.abiDeploymentBase() : base(BYTECODE) { }
        public SharedVaults.abiDeploymentBase(string byteCode) : base(byteCode) { }
