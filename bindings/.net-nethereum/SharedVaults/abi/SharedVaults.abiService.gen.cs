...
using Symbiotic.Relay.SharedVaults.abi.ContractDefinition;

namespace Symbiotic.Relay.SharedVaults.abi
{
    public partial class SharedVaults.abiService: SharedVaults.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, SharedVaults.abiDeployment sharedVaults.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<SharedVaults.abiDeployment>().SendRequestAndWaitForReceiptAsync(sharedVaults.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, SharedVaults.abiDeployment sharedVaults.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SharedVaults.abiDeployment>().SendRequestAsync(sharedVaults.abiDeployment);
        }

        public static async Task<SharedVaults.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, SharedVaults.abiDeployment sharedVaults.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, sharedVaults.abiDeployment, cancellationTokenSource);
            return new SharedVaults.abiService(web3, receipt.ContractAddress);
        }

        public SharedVaults.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class SharedVaults.abiServiceBase: ContractWeb3ServiceBase
    {

        public SharedVaults.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
