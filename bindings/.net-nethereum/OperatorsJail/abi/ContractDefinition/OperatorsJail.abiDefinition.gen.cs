...
namespace Symbiotic.Relay.OperatorsJail.abi.ContractDefinition
{


    public partial class OperatorsJail.abiDeployment : OperatorsJail.abiDeploymentBase
    {
        public OperatorsJail.abiDeployment() : base(BYTECODE) { }
        public OperatorsJail.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OperatorsJail.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OperatorsJail.abiDeploymentBase() : base(BYTECODE) { }
        public OperatorsJail.abiDeploymentBase(string byteCode) : base(byteCode) { }
