...
using Symbiotic.Relay.OperatorsJail.abi.ContractDefinition;

namespace Symbiotic.Relay.OperatorsJail.abi
{
    public partial class OperatorsJail.abiService: OperatorsJail.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, OperatorsJail.abiDeployment operatorsJail.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsJail.abiDeployment>().SendRequestAndWaitForReceiptAsync(operatorsJail.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, OperatorsJail.abiDeployment operatorsJail.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsJail.abiDeployment>().SendRequestAsync(operatorsJail.abiDeployment);
        }

        public static async Task<OperatorsJail.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, OperatorsJail.abiDeployment operatorsJail.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, operatorsJail.abiDeployment, cancellationTokenSource);
            return new OperatorsJail.abiService(web3, receipt.ContractAddress);
        }

        public OperatorsJail.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class OperatorsJail.abiServiceBase: ContractWeb3ServiceBase
    {

        public OperatorsJail.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
