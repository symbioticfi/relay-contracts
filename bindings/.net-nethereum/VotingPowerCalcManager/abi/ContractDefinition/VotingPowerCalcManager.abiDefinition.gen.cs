...
namespace Symbiotic.Relay.VotingPowerCalcManager.abi.ContractDefinition
{


    public partial class VotingPowerCalcManager.abiDeployment : VotingPowerCalcManager.abiDeploymentBase
    {
        public VotingPowerCalcManager.abiDeployment() : base(BYTECODE) { }
        public VotingPowerCalcManager.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class VotingPowerCalcManager.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public VotingPowerCalcManager.abiDeploymentBase() : base(BYTECODE) { }
        public VotingPowerCalcManager.abiDeploymentBase(string byteCode) : base(byteCode) { }
