...
namespace Symbiotic.Relay.Settlement.abi.ContractDefinition
{


    public partial class Settlement.abiDeployment : Settlement.abiDeploymentBase
    {
        public Settlement.abiDeployment() : base(BYTECODE) { }
        public Settlement.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class Settlement.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public Settlement.abiDeploymentBase() : base(BYTECODE) { }
        public Settlement.abiDeploymentBase(string byteCode) : base(byteCode) { }
