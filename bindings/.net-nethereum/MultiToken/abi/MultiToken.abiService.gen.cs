...
using Symbiotic.Relay.MultiToken.abi.ContractDefinition;

namespace Symbiotic.Relay.MultiToken.abi
{
    public partial class MultiToken.abiService: MultiToken.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, MultiToken.abiDeployment multiToken.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<MultiToken.abiDeployment>().SendRequestAndWaitForReceiptAsync(multiToken.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, MultiToken.abiDeployment multiToken.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<MultiToken.abiDeployment>().SendRequestAsync(multiToken.abiDeployment);
        }

        public static async Task<MultiToken.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, MultiToken.abiDeployment multiToken.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, multiToken.abiDeployment, cancellationTokenSource);
            return new MultiToken.abiService(web3, receipt.ContractAddress);
        }

        public MultiToken.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class MultiToken.abiServiceBase: ContractWeb3ServiceBase
    {

        public MultiToken.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
