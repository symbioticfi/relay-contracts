...
namespace Symbiotic.Relay.MultiToken.abi.ContractDefinition
{


    public partial class MultiToken.abiDeployment : MultiToken.abiDeploymentBase
    {
        public MultiToken.abiDeployment() : base(BYTECODE) { }
        public MultiToken.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class MultiToken.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public MultiToken.abiDeploymentBase() : base(BYTECODE) { }
        public MultiToken.abiDeploymentBase(string byteCode) : base(byteCode) { }
