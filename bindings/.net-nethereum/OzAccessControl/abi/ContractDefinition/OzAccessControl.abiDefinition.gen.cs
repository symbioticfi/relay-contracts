...
namespace Symbiotic.Relay.OzAccessControl.abi.ContractDefinition
{


    public partial class OzAccessControl.abiDeployment : OzAccessControl.abiDeploymentBase
    {
        public OzAccessControl.abiDeployment() : base(BYTECODE) { }
        public OzAccessControl.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OzAccessControl.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OzAccessControl.abiDeploymentBase() : base(BYTECODE) { }
        public OzAccessControl.abiDeploymentBase(string byteCode) : base(byteCode) { }
