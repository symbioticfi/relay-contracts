...
namespace Symbiotic.Relay.OpNetVaultAutoDeploy.abi.ContractDefinition
{
    ...
    public partial class OpNetVaultAutoDeploy.abiDeployment : OpNetVaultAutoDeploy.abiDeploymentBase
    {
        public OpNetVaultAutoDeploy.abiDeployment() : base(BYTECODE) { }
        public OpNetVaultAutoDeploy.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OpNetVaultAutoDeploy.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OpNetVaultAutoDeploy.abiDeploymentBase() : base(BYTECODE) { }
        public OpNetVaultAutoDeploy.abiDeploymentBase(string byteCode) : base(byteCode) { }
