...
using Symbiotic.Relay.OpNetVaultAutoDeploy.abi.ContractDefinition;

namespace Symbiotic.Relay.OpNetVaultAutoDeploy.abi
{
    public partial class OpNetVaultAutoDeploy.abiService: OpNetVaultAutoDeploy.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, OpNetVaultAutoDeploy.abiDeployment opNetVaultAutoDeploy.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OpNetVaultAutoDeploy.abiDeployment>().SendRequestAndWaitForReceiptAsync(opNetVaultAutoDeploy.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, OpNetVaultAutoDeploy.abiDeployment opNetVaultAutoDeploy.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OpNetVaultAutoDeploy.abiDeployment>().SendRequestAsync(opNetVaultAutoDeploy.abiDeployment);
        }

        public static async Task<OpNetVaultAutoDeploy.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, OpNetVaultAutoDeploy.abiDeployment opNetVaultAutoDeploy.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, opNetVaultAutoDeploy.abiDeployment, cancellationTokenSource);
            return new OpNetVaultAutoDeploy.abiService(web3, receipt.ContractAddress);
        }

        public OpNetVaultAutoDeploy.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class OpNetVaultAutoDeploy.abiServiceBase: ContractWeb3ServiceBase
    {

        public OpNetVaultAutoDeploy.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
