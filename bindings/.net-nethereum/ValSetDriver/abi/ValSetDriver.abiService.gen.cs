...
using Symbiotic.Relay.ValSetDriver.abi.ContractDefinition;

namespace Symbiotic.Relay.ValSetDriver.abi
{
    public partial class ValSetDriver.abiService: ValSetDriver.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, ValSetDriver.abiDeployment valSetDriver.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ValSetDriver.abiDeployment>().SendRequestAndWaitForReceiptAsync(valSetDriver.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, ValSetDriver.abiDeployment valSetDriver.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ValSetDriver.abiDeployment>().SendRequestAsync(valSetDriver.abiDeployment);
        }

        public static async Task<ValSetDriver.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, ValSetDriver.abiDeployment valSetDriver.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, valSetDriver.abiDeployment, cancellationTokenSource);
            return new ValSetDriver.abiService(web3, receipt.ContractAddress);
        }

        public ValSetDriver.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class ValSetDriver.abiServiceBase: ContractWeb3ServiceBase
    {

        public ValSetDriver.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
