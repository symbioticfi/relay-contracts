...
namespace Symbiotic.Relay.OperatorVaults.abi.ContractDefinition
{


    public partial class OperatorVaults.abiDeployment : OperatorVaults.abiDeploymentBase
    {
        public OperatorVaults.abiDeployment() : base(BYTECODE) { }
        public OperatorVaults.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OperatorVaults.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OperatorVaults.abiDeploymentBase() : base(BYTECODE) { }
        public OperatorVaults.abiDeploymentBase(string byteCode) : base(byteCode) { }
