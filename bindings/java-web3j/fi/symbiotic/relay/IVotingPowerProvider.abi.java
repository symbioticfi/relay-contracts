...
public class IVotingPowerProvider.abi extends Contract {
    ...
    @Deprecated
    protected IVotingPowerProvider.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected IVotingPowerProvider.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static IVotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IVotingPowerProvider.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IVotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IVotingPowerProvider.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IVotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IVotingPowerProvider.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IVotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IVotingPowerProvider.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
