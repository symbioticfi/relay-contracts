...
public class ValSetDriver.abi extends Contract {
    ...
    public static final CustomError DUPLICATEKEYTAG_ERROR = new CustomError("DuplicateKeyTag", 
            Arrays.<TypeReference<?>>asList());
    ;
    ...
    public static final CustomError INVALIDKEY_ERROR = new CustomError("InvalidKey", 
            Arrays.<TypeReference<?>>asList());
    ;
    ...
    @Deprecated
    protected ValSetDriver.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected ValSetDriver.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static ValSetDriver.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ValSetDriver.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ValSetDriver.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ValSetDriver.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ValSetDriver.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ValSetDriver.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ValSetDriver.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ValSetDriver.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
