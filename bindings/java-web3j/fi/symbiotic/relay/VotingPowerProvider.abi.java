...
public class VotingPowerProvider.abi extends Contract {
    ...
    @Deprecated
    protected VotingPowerProvider.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected VotingPowerProvider.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static VotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new VotingPowerProvider.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static VotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new VotingPowerProvider.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static VotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new VotingPowerProvider.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static VotingPowerProvider.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new VotingPowerProvider.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
