...
public class Settlement.abi extends Contract {
    ...
    @Deprecated
    protected Settlement.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected Settlement.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static Settlement.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new Settlement.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Settlement.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Settlement.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Settlement.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new Settlement.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Settlement.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new Settlement.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
