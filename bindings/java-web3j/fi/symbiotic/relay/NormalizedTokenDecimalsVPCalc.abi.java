...
public class NormalizedTokenDecimalsVPCalc.abi extends Contract {
    ...
    @Deprecated
    protected NormalizedTokenDecimalsVPCalc.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static NormalizedTokenDecimalsVPCalc.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new NormalizedTokenDecimalsVPCalc.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static NormalizedTokenDecimalsVPCalc.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new NormalizedTokenDecimalsVPCalc.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static NormalizedTokenDecimalsVPCalc.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new NormalizedTokenDecimalsVPCalc.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static NormalizedTokenDecimalsVPCalc.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new NormalizedTokenDecimalsVPCalc.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
