...
public class PricedTokensChainlinkVPCalc.abi extends Contract {
    ...
    @Deprecated
    protected PricedTokensChainlinkVPCalc.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static PricedTokensChainlinkVPCalc.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PricedTokensChainlinkVPCalc.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PricedTokensChainlinkVPCalc.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PricedTokensChainlinkVPCalc.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static PricedTokensChainlinkVPCalc.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PricedTokensChainlinkVPCalc.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static PricedTokensChainlinkVPCalc.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PricedTokensChainlinkVPCalc.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
