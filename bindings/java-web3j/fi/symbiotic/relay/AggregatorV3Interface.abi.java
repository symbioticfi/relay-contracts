...
public class AggregatorV3Interface.abi extends Contract {
    ...
    @Deprecated
    protected AggregatorV3Interface.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static AggregatorV3Interface.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new AggregatorV3Interface.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static AggregatorV3Interface.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new AggregatorV3Interface.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static AggregatorV3Interface.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new AggregatorV3Interface.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static AggregatorV3Interface.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new AggregatorV3Interface.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
