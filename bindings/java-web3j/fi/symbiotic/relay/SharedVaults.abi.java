...
public class SharedVaults.abi extends Contract {
    ...
    @Deprecated
    protected SharedVaults.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected SharedVaults.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static SharedVaults.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new SharedVaults.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static SharedVaults.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new SharedVaults.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static SharedVaults.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new SharedVaults.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static SharedVaults.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new SharedVaults.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
