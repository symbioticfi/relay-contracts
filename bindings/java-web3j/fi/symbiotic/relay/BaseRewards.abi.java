...
public class BaseRewards.abi extends Contract {
    ...
    @Deprecated
    protected BaseRewards.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected BaseRewards.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static BaseRewards.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new BaseRewards.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static BaseRewards.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new BaseRewards.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static BaseRewards.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new BaseRewards.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static BaseRewards.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new BaseRewards.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
