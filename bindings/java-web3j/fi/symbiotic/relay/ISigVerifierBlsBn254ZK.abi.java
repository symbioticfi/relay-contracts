...
public class ISigVerifierBlsBn254ZK.abi extends Contract {
    ...
    @Deprecated
    protected ISigVerifierBlsBn254ZK.abi(String contractAddress, Web3j web3j,
    ...
    public RemoteFunctionCall<BigInteger> maxValidators(BigInteger index) {
    ...
    public RemoteFunctionCall<String> verifiers(BigInteger index) {
    ...
    @Deprecated
    public static ISigVerifierBlsBn254ZK.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ISigVerifierBlsBn254ZK.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ISigVerifierBlsBn254ZK.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ISigVerifierBlsBn254ZK.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ISigVerifierBlsBn254ZK.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ISigVerifierBlsBn254ZK.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ISigVerifierBlsBn254ZK.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ISigVerifierBlsBn254ZK.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
