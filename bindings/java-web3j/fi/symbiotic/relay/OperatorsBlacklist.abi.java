...
public class OperatorsBlacklist.abi extends Contract {
    ...
    @Deprecated
    protected OperatorsBlacklist.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OperatorsBlacklist.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OperatorsBlacklist.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsBlacklist.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OperatorsBlacklist.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsBlacklist.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OperatorsBlacklist.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OperatorsBlacklist.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OperatorsBlacklist.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OperatorsBlacklist.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
