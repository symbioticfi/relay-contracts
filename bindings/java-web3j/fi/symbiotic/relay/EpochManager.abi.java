...
public class EpochManager.abi extends Contract {
    ...
    @Deprecated
    protected EpochManager.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected EpochManager.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static EpochManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new EpochManager.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static EpochManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new EpochManager.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static EpochManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new EpochManager.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static EpochManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new EpochManager.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
