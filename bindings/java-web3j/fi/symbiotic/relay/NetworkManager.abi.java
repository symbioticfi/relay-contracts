...
public class NetworkManager.abi extends Contract {
    ...
    @Deprecated
    protected NetworkManager.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected NetworkManager.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static NetworkManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new NetworkManager.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static NetworkManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new NetworkManager.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static NetworkManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new NetworkManager.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static NetworkManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new NetworkManager.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
