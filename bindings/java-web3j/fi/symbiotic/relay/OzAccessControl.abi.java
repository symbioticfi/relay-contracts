...
public class OzAccessControl.abi extends Contract {
    ...
    @Deprecated
    protected OzAccessControl.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OzAccessControl.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OzAccessControl.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OzAccessControl.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OzAccessControl.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OzAccessControl.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OzAccessControl.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OzAccessControl.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OzAccessControl.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OzAccessControl.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
