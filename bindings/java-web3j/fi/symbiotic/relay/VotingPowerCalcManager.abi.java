...
public class VotingPowerCalcManager.abi extends Contract {
    ...
    @Deprecated
    protected VotingPowerCalcManager.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static VotingPowerCalcManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new VotingPowerCalcManager.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static VotingPowerCalcManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new VotingPowerCalcManager.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static VotingPowerCalcManager.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new VotingPowerCalcManager.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static VotingPowerCalcManager.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new VotingPowerCalcManager.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
