...
public class OperatorsWhitelist.abi extends Contract {
    ...
    @Deprecated
    protected OperatorsWhitelist.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OperatorsWhitelist.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OperatorsWhitelist.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsWhitelist.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OperatorsWhitelist.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsWhitelist.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OperatorsWhitelist.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OperatorsWhitelist.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OperatorsWhitelist.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OperatorsWhitelist.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
