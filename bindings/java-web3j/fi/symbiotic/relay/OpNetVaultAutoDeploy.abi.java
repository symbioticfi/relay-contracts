...
public class OpNetVaultAutoDeploy.abi extends Contract {
    ...
    @Deprecated
    protected OpNetVaultAutoDeploy.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OpNetVaultAutoDeploy.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OpNetVaultAutoDeploy.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OpNetVaultAutoDeploy.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OpNetVaultAutoDeploy.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OpNetVaultAutoDeploy.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OpNetVaultAutoDeploy.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OpNetVaultAutoDeploy.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OpNetVaultAutoDeploy.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OpNetVaultAutoDeploy.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
