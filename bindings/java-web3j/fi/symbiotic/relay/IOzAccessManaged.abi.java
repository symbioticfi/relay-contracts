...
public class IOzAccessManaged.abi extends Contract {
    ...
    @Deprecated
    protected IOzAccessManaged.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected IOzAccessManaged.abi(String contractAddress, Web3j web3j,
    ...
    public RemoteFunctionCall<TransactionReceipt> setAuthority(String param0) {
    ...
    @Deprecated
    public static IOzAccessManaged.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new IOzAccessManaged.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IOzAccessManaged.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new IOzAccessManaged.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static IOzAccessManaged.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new IOzAccessManaged.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static IOzAccessManaged.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new IOzAccessManaged.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
