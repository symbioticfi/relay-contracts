...
public class OperatorsJail.abi extends Contract {
    ...
    @Deprecated
    protected OperatorsJail.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OperatorsJail.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OperatorsJail.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsJail.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OperatorsJail.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorsJail.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OperatorsJail.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OperatorsJail.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OperatorsJail.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OperatorsJail.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
