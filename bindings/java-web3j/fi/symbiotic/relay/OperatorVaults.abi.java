...
public class OperatorVaults.abi extends Contract {
    ...
    @Deprecated
    protected OperatorVaults.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OperatorVaults.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OperatorVaults.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorVaults.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OperatorVaults.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OperatorVaults.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OperatorVaults.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new OperatorVaults.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OperatorVaults.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OperatorVaults.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
