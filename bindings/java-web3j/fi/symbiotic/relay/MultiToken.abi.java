...
public class MultiToken.abi extends Contract {
    ...
    @Deprecated
    protected MultiToken.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected MultiToken.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static MultiToken.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new MultiToken.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static MultiToken.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new MultiToken.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static MultiToken.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new MultiToken.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static MultiToken.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new MultiToken.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
