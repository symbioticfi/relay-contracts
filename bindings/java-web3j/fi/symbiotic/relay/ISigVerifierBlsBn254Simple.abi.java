...
public class ISigVerifierBlsBn254Simple.abi extends Contract {
    ...
    @Deprecated
    protected ISigVerifierBlsBn254Simple.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static ISigVerifierBlsBn254Simple.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ISigVerifierBlsBn254Simple.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ISigVerifierBlsBn254Simple.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ISigVerifierBlsBn254Simple.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ISigVerifierBlsBn254Simple.abi load(String contractAddress, Web3j web3j,
            Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ISigVerifierBlsBn254Simple.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ISigVerifierBlsBn254Simple.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ISigVerifierBlsBn254Simple.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
