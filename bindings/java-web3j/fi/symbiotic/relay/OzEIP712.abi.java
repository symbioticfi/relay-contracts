...
public class OzEIP712.abi extends Contract {
    ...
    @Deprecated
    protected OzEIP712.abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected OzEIP712.abi(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static OzEIP712.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new OzEIP712.abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static OzEIP712.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new OzEIP712.abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static OzEIP712.abi load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new OzEIP712.abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static OzEIP712.abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new OzEIP712.abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
