...
namespace Symbiotic.Relay.BaseRewards.abi.ContractDefinition
{


    public partial class BaseRewards.abiDeployment : BaseRewards.abiDeploymentBase
    {
        public BaseRewards.abiDeployment() : base(BYTECODE) { }
        public BaseRewards.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class BaseRewards.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public BaseRewards.abiDeploymentBase() : base(BYTECODE) { }
        public BaseRewards.abiDeploymentBase(string byteCode) : base(byteCode) { }
