...
namespace Symbiotic.Relay.SigVerifierBlsBn254ZK.abi.ContractDefinition
{


    public partial class SigVerifierBlsBn254ZK.abiDeployment : SigVerifierBlsBn254ZK.abiDeploymentBase
    {
        public SigVerifierBlsBn254ZK.abiDeployment() : base(BYTECODE) { }
        public SigVerifierBlsBn254ZK.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class SigVerifierBlsBn254ZK.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public SigVerifierBlsBn254ZK.abiDeploymentBase() : base(BYTECODE) { }
        public SigVerifierBlsBn254ZK.abiDeploymentBase(string byteCode) : base(byteCode) { }
        [Parameter("address[]", "verifiers_", 1)]
        public virtual List<string> Verifiers { get; set; }
        [Parameter("uint256[]", "maxValidators_", 2)]
        public virtual List<BigInteger> Maxvalidators { get; set; }
    }
