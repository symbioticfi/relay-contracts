...
using Symbiotic.Relay.IPricedTokensChainlinkVPCalc.abi.ContractDefinition;

namespace Symbiotic.Relay.IPricedTokensChainlinkVPCalc.abi
{
    public partial class IPricedTokensChainlinkVPCalc.abiService: IPricedTokensChainlinkVPCalc.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, IPricedTokensChainlinkVPCalc.abiDeployment iPricedTokensChainlinkVPCalc.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IPricedTokensChainlinkVPCalc.abiDeployment>().SendRequestAndWaitForReceiptAsync(iPricedTokensChainlinkVPCalc.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, IPricedTokensChainlinkVPCalc.abiDeployment iPricedTokensChainlinkVPCalc.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IPricedTokensChainlinkVPCalc.abiDeployment>().SendRequestAsync(iPricedTokensChainlinkVPCalc.abiDeployment);
        }

        public static async Task<IPricedTokensChainlinkVPCalc.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, IPricedTokensChainlinkVPCalc.abiDeployment iPricedTokensChainlinkVPCalc.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iPricedTokensChainlinkVPCalc.abiDeployment, cancellationTokenSource);
            return new IPricedTokensChainlinkVPCalc.abiService(web3, receipt.ContractAddress);
        }

        public IPricedTokensChainlinkVPCalc.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class IPricedTokensChainlinkVPCalc.abiServiceBase: ContractWeb3ServiceBase
    {

        public IPricedTokensChainlinkVPCalc.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
