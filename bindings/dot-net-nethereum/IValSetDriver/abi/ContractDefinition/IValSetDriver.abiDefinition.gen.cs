...
namespace Symbiotic.Relay.IValSetDriver.abi.ContractDefinition
{
    ...
    public partial class IValSetDriver.abiDeployment : IValSetDriver.abiDeploymentBase
    {
        public IValSetDriver.abiDeployment() : base(BYTECODE) { }
        public IValSetDriver.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class IValSetDriver.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IValSetDriver.abiDeploymentBase() : base(BYTECODE) { }
        public IValSetDriver.abiDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    {
        [Parameter("tuple[]", "", 1)]
        public virtual List<QuorumThreshold> ReturnValue1 { get; set; }
    }
    ...
    {
        [Parameter("tuple[]", "", 1)]
        public virtual List<CrossChainAddress> ReturnValue1 { get; set; }
    }
