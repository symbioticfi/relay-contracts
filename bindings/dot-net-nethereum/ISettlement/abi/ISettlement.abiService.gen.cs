...
using Symbiotic.Relay.ISettlement.abi.ContractDefinition;

namespace Symbiotic.Relay.ISettlement.abi
{
    public partial class ISettlement.abiService: ISettlement.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, ISettlement.abiDeployment iSettlement.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ISettlement.abiDeployment>().SendRequestAndWaitForReceiptAsync(iSettlement.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, ISettlement.abiDeployment iSettlement.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ISettlement.abiDeployment>().SendRequestAsync(iSettlement.abiDeployment);
        }

        public static async Task<ISettlement.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, ISettlement.abiDeployment iSettlement.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iSettlement.abiDeployment, cancellationTokenSource);
            return new ISettlement.abiService(web3, receipt.ContractAddress);
        }

        public ISettlement.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class ISettlement.abiServiceBase: ContractWeb3ServiceBase
    {

        public ISettlement.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
