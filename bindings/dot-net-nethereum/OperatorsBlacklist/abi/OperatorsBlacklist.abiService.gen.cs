...
using Symbiotic.Relay.OperatorsBlacklist.abi.ContractDefinition;

namespace Symbiotic.Relay.OperatorsBlacklist.abi
{
    public partial class OperatorsBlacklist.abiService: OperatorsBlacklist.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, OperatorsBlacklist.abiDeployment operatorsBlacklist.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsBlacklist.abiDeployment>().SendRequestAndWaitForReceiptAsync(operatorsBlacklist.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, OperatorsBlacklist.abiDeployment operatorsBlacklist.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorsBlacklist.abiDeployment>().SendRequestAsync(operatorsBlacklist.abiDeployment);
        }

        public static async Task<OperatorsBlacklist.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, OperatorsBlacklist.abiDeployment operatorsBlacklist.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, operatorsBlacklist.abiDeployment, cancellationTokenSource);
            return new OperatorsBlacklist.abiService(web3, receipt.ContractAddress);
        }

        public OperatorsBlacklist.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class OperatorsBlacklist.abiServiceBase: ContractWeb3ServiceBase
    {

        public OperatorsBlacklist.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
