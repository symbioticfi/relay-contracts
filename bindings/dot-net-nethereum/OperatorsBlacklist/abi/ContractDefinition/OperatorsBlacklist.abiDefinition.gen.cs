...
namespace Symbiotic.Relay.OperatorsBlacklist.abi.ContractDefinition
{


    public partial class OperatorsBlacklist.abiDeployment : OperatorsBlacklist.abiDeploymentBase
    {
        public OperatorsBlacklist.abiDeployment() : base(BYTECODE) { }
        public OperatorsBlacklist.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class OperatorsBlacklist.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OperatorsBlacklist.abiDeploymentBase() : base(BYTECODE) { }
        public OperatorsBlacklist.abiDeploymentBase(string byteCode) : base(byteCode) { }
