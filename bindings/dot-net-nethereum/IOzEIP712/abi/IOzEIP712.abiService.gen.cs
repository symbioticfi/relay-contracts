...
using Symbiotic.Relay.IOzEIP712.abi.ContractDefinition;

namespace Symbiotic.Relay.IOzEIP712.abi
{
    public partial class IOzEIP712.abiService: IOzEIP712.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, IOzEIP712.abiDeployment iOzEIP712.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IOzEIP712.abiDeployment>().SendRequestAndWaitForReceiptAsync(iOzEIP712.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, IOzEIP712.abiDeployment iOzEIP712.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IOzEIP712.abiDeployment>().SendRequestAsync(iOzEIP712.abiDeployment);
        }

        public static async Task<IOzEIP712.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, IOzEIP712.abiDeployment iOzEIP712.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iOzEIP712.abiDeployment, cancellationTokenSource);
            return new IOzEIP712.abiService(web3, receipt.ContractAddress);
        }

        public IOzEIP712.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class IOzEIP712.abiServiceBase: ContractWeb3ServiceBase
    {

        public IOzEIP712.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
