...
namespace Symbiotic.Relay.IOzEIP712.abi.ContractDefinition
{


    public partial class IOzEIP712.abiDeployment : IOzEIP712.abiDeploymentBase
    {
        public IOzEIP712.abiDeployment() : base(BYTECODE) { }
        public IOzEIP712.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class IOzEIP712.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IOzEIP712.abiDeploymentBase() : base(BYTECODE) { }
        public IOzEIP712.abiDeploymentBase(string byteCode) : base(byteCode) { }
