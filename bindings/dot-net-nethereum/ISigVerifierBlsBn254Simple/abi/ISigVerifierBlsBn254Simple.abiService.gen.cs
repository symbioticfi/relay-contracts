...
using Symbiotic.Relay.ISigVerifierBlsBn254Simple.abi.ContractDefinition;

namespace Symbiotic.Relay.ISigVerifierBlsBn254Simple.abi
{
    public partial class ISigVerifierBlsBn254Simple.abiService: ISigVerifierBlsBn254Simple.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, ISigVerifierBlsBn254Simple.abiDeployment iSigVerifierBlsBn254Simple.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ISigVerifierBlsBn254Simple.abiDeployment>().SendRequestAndWaitForReceiptAsync(iSigVerifierBlsBn254Simple.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, ISigVerifierBlsBn254Simple.abiDeployment iSigVerifierBlsBn254Simple.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ISigVerifierBlsBn254Simple.abiDeployment>().SendRequestAsync(iSigVerifierBlsBn254Simple.abiDeployment);
        }

        public static async Task<ISigVerifierBlsBn254Simple.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, ISigVerifierBlsBn254Simple.abiDeployment iSigVerifierBlsBn254Simple.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iSigVerifierBlsBn254Simple.abiDeployment, cancellationTokenSource);
            return new ISigVerifierBlsBn254Simple.abiService(web3, receipt.ContractAddress);
        }

        public ISigVerifierBlsBn254Simple.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class ISigVerifierBlsBn254Simple.abiServiceBase: ContractWeb3ServiceBase
    {

        public ISigVerifierBlsBn254Simple.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
