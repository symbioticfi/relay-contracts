...
namespace Symbiotic.Relay.ISigVerifierBlsBn254Simple.abi.ContractDefinition
{


    public partial class ISigVerifierBlsBn254Simple.abiDeployment : ISigVerifierBlsBn254Simple.abiDeploymentBase
    {
        public ISigVerifierBlsBn254Simple.abiDeployment() : base(BYTECODE) { }
        public ISigVerifierBlsBn254Simple.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class ISigVerifierBlsBn254Simple.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public ISigVerifierBlsBn254Simple.abiDeploymentBase() : base(BYTECODE) { }
        public ISigVerifierBlsBn254Simple.abiDeploymentBase(string byteCode) : base(byteCode) { }
