...
namespace Symbiotic.Relay.VotingPowerProvider.abi.ContractDefinition
{


    public partial class VotingPowerProvider.abiDeployment : VotingPowerProvider.abiDeploymentBase
    {
        public VotingPowerProvider.abiDeployment() : base(BYTECODE) { }
        public VotingPowerProvider.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class VotingPowerProvider.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public VotingPowerProvider.abiDeploymentBase() : base(BYTECODE) { }
        public VotingPowerProvider.abiDeploymentBase(string byteCode) : base(byteCode) { }
