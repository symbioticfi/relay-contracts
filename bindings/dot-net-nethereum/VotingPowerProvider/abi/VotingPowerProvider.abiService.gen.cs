...
using Symbiotic.Relay.VotingPowerProvider.abi.ContractDefinition;

namespace Symbiotic.Relay.VotingPowerProvider.abi
{
    public partial class VotingPowerProvider.abiService: VotingPowerProvider.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, VotingPowerProvider.abiDeployment votingPowerProvider.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<VotingPowerProvider.abiDeployment>().SendRequestAndWaitForReceiptAsync(votingPowerProvider.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, VotingPowerProvider.abiDeployment votingPowerProvider.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<VotingPowerProvider.abiDeployment>().SendRequestAsync(votingPowerProvider.abiDeployment);
        }

        public static async Task<VotingPowerProvider.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, VotingPowerProvider.abiDeployment votingPowerProvider.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, votingPowerProvider.abiDeployment, cancellationTokenSource);
            return new VotingPowerProvider.abiService(web3, receipt.ContractAddress);
        }

        public VotingPowerProvider.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class VotingPowerProvider.abiServiceBase: ContractWeb3ServiceBase
    {

        public VotingPowerProvider.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
