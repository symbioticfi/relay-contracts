...
using Symbiotic.Relay.BaseSlashing.abi.ContractDefinition;

namespace Symbiotic.Relay.BaseSlashing.abi
{
    public partial class BaseSlashing.abiService: BaseSlashing.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, BaseSlashing.abiDeployment baseSlashing.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BaseSlashing.abiDeployment>().SendRequestAndWaitForReceiptAsync(baseSlashing.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, BaseSlashing.abiDeployment baseSlashing.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BaseSlashing.abiDeployment>().SendRequestAsync(baseSlashing.abiDeployment);
        }

        public static async Task<BaseSlashing.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, BaseSlashing.abiDeployment baseSlashing.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, baseSlashing.abiDeployment, cancellationTokenSource);
            return new BaseSlashing.abiService(web3, receipt.ContractAddress);
        }

        public BaseSlashing.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class BaseSlashing.abiServiceBase: ContractWeb3ServiceBase
    {

        public BaseSlashing.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
