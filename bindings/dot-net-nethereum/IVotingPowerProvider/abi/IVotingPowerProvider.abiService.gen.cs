...
using Symbiotic.Relay.IVotingPowerProvider.abi.ContractDefinition;

namespace Symbiotic.Relay.IVotingPowerProvider.abi
{
    public partial class IVotingPowerProvider.abiService: IVotingPowerProvider.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, IVotingPowerProvider.abiDeployment iVotingPowerProvider.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IVotingPowerProvider.abiDeployment>().SendRequestAndWaitForReceiptAsync(iVotingPowerProvider.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, IVotingPowerProvider.abiDeployment iVotingPowerProvider.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IVotingPowerProvider.abiDeployment>().SendRequestAsync(iVotingPowerProvider.abiDeployment);
        }

        public static async Task<IVotingPowerProvider.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, IVotingPowerProvider.abiDeployment iVotingPowerProvider.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iVotingPowerProvider.abiDeployment, cancellationTokenSource);
            return new IVotingPowerProvider.abiService(web3, receipt.ContractAddress);
        }

        public IVotingPowerProvider.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class IVotingPowerProvider.abiServiceBase: ContractWeb3ServiceBase
    {

        public IVotingPowerProvider.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
