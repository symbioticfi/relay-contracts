...
namespace Symbiotic.Relay.IVotingPowerProvider.abi.ContractDefinition
{


    public partial class IVotingPowerProvider.abiDeployment : IVotingPowerProvider.abiDeploymentBase
    {
        public IVotingPowerProvider.abiDeployment() : base(BYTECODE) { }
        public IVotingPowerProvider.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class IVotingPowerProvider.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IVotingPowerProvider.abiDeploymentBase() : base(BYTECODE) { }
        public IVotingPowerProvider.abiDeploymentBase(string byteCode) : base(byteCode) { }
