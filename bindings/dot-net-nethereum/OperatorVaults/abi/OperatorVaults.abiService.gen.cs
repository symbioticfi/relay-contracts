...
using Symbiotic.Relay.OperatorVaults.abi.ContractDefinition;

namespace Symbiotic.Relay.OperatorVaults.abi
{
    public partial class OperatorVaults.abiService: OperatorVaults.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, OperatorVaults.abiDeployment operatorVaults.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorVaults.abiDeployment>().SendRequestAndWaitForReceiptAsync(operatorVaults.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, OperatorVaults.abiDeployment operatorVaults.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OperatorVaults.abiDeployment>().SendRequestAsync(operatorVaults.abiDeployment);
        }

        public static async Task<OperatorVaults.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, OperatorVaults.abiDeployment operatorVaults.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, operatorVaults.abiDeployment, cancellationTokenSource);
            return new OperatorVaults.abiService(web3, receipt.ContractAddress);
        }

        public OperatorVaults.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class OperatorVaults.abiServiceBase: ContractWeb3ServiceBase
    {

        public OperatorVaults.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
