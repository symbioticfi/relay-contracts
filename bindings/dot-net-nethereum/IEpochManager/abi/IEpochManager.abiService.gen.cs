...
using Symbiotic.Relay.IEpochManager.abi.ContractDefinition;

namespace Symbiotic.Relay.IEpochManager.abi
{
    public partial class IEpochManager.abiService: IEpochManager.abiServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, IEpochManager.abiDeployment iEpochManager.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IEpochManager.abiDeployment>().SendRequestAndWaitForReceiptAsync(iEpochManager.abiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, IEpochManager.abiDeployment iEpochManager.abiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IEpochManager.abiDeployment>().SendRequestAsync(iEpochManager.abiDeployment);
        }

        public static async Task<IEpochManager.abiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, IEpochManager.abiDeployment iEpochManager.abiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iEpochManager.abiDeployment, cancellationTokenSource);
            return new IEpochManager.abiService(web3, receipt.ContractAddress);
        }

        public IEpochManager.abiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class IEpochManager.abiServiceBase: ContractWeb3ServiceBase
    {

        public IEpochManager.abiServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
