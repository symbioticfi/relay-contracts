...
namespace Symbiotic.Relay.IEpochManager.abi.ContractDefinition
{


    public partial class IEpochManager.abiDeployment : IEpochManager.abiDeploymentBase
    {
        public IEpochManager.abiDeployment() : base(BYTECODE) { }
        public IEpochManager.abiDeployment(string byteCode) : base(byteCode) { }
    }

    public class IEpochManager.abiDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IEpochManager.abiDeploymentBase() : base(BYTECODE) { }
        public IEpochManager.abiDeploymentBase(string byteCode) : base(byteCode) { }
