...
contract VaultManager is OperatorManager {
    ...
    function removeSharedVault(
        ...
        VaultManagerLogic.removeSharedVault(
            _getVaultManagerStorage(), _getOperatorManagerStorage(), _getNetworkConfigStorage(), vault
        );
    }

    function removeOperatorVault(address operator, address vault) public onlyRole(OPERATOR_VAULT_REMOVE_ROLE) {
        VaultManagerLogic.removeOperatorVault(
            _getVaultManagerStorage(), _getOperatorManagerStorage(), _getNetworkConfigStorage(), operator, vault
        );
    }
    ...
    function requestSlash(
        ...
        VaultManagerLogic.requestSlash(
            _getVaultManagerStorage(),
            _getOperatorManagerStorage(),
            _getNetworkConfigStorage(),
            operator,
