    ...
    ISelfRegisterVotingPowerProvider
{
    ...
    function initialize(
        ...
        WhitelistSelfRegisterOperatorsInitParams memory whitelistSelfRegisterOperatorsInitParams,
        ...
        __WhitelistSelfRegisterOperators_init(whitelistSelfRegisterOperatorsInitParams);
        __Tokens_init();
